        ...
        return (
            <div id="quiz">
                ...
                <div className="text-center">
                    {this.props.quiz.config.allowBack && <button id="first" className="btn btn-info" onClick={this.props.move}>First</button>}
                    {this.props.quiz.config.allowBack && <button id="prev" className="btn btn-info" onClick={this.props.move}>Prev</button>}
                    <button id="next" className="btn btn-info" onClick={this.props.move}>Next</button>
                    <button id="last" className="btn btn-info" onClick={this.props.move}>Last</button>
                </div>
            </div >
        )
    }
